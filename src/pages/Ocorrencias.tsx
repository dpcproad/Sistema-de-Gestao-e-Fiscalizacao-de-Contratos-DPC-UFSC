...
const Ocorrencias = () => {
  ...
  const [userSector, setUserSector] = useState("Reitoria I") // Default to Reitoria I as in the example
  ...
  // Mock data for contract and user profile
  const contractInfo = {
    number: "123/2023",
    company: "Empresa de Limpeza Ltda.",
    object: "Serviços de limpeza e conservação",
    validity: "12/01/2023 a 12/01/2024",
  }
  ...
  // Set sector to user's sector on component mount
  useEffect(() => {
  ...
  const sectors = [
    ...
    { id: "reitoria", name: "Reitoria I" },
    { id: "bu", name: "BU - Biblioteca Universitária" },
    { id: "ru", name: "RU - Restaurante Universitário" },
  ]

  // Find the user's sector ID based on the name
  const userSectorId = sectors.find(s => s.name === userSector)?.id || "reitoria";
              ...
              <DialogContent>
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Select value={sector} onValueChange={setSector} defaultValue={userSectorId}>
                      <SelectTrigger>
                        <SelectValue placeholder={userSector} />
                      </SelectTrigger>
                      <SelectContent>
                        {sectors.map(sector => (
